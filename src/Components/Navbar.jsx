    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <div className="container-fluid" style={{ width: "180px" }}>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <svg style={{ marginRight: "2rem", cursor: "pointer" }} onClick={handleProfile} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" class="bi bi-person-fill" viewBox="0 0 16 16"> <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /> </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" onClick={handleLogOut} width="30" height="30" fill="blue" className="bi bi-box-arrow-right" viewBox="0 0 16 16" style={{ cursor: "pointer" }}>
